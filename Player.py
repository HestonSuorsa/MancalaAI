...
class nyg316(Player):
    ...
    def score(self, board):
        ...
        myScore = board.scoreCups[self.num]  #amount of rocks in my Mancala
        oppScore = board.scoreCups[self.opp] #amount of rocks in opp Mancala
        utility= myScore - oppScore #finding difference in stones in both Mancalas
        #if utility is negative the opp is winning
        #if utility is positive I am winning
